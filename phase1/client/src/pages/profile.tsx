        ...
        <section className="pt-24 md:pt-16 pb-16 px-4">
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex items-center justify-center space-x-3 mb-6">
              <img src={logoPath} alt="Liqify Logo" className="h-12 w-12" />
      ...
      <section className="pt-24 md:pt-16 pb-8 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center space-x-4 mb-8">
            <div className="w-20 h-20 rounded-full bg-gradient-to-br from-electric-purple to-cyber-blue flex items-center justify-center">
              <User className="h-10 w-10 text-white" />
            </div>
            <div>
              <h1 className="text-3xl font-bold gradient-text-primary">Trading Profile</h1>
              <p className="text-gray-400">Wallet: {publicKey}</p>
            </div>
          </div>
        </div>
      </section>
