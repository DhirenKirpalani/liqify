...
export default function NavigationBar() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-neutral/20 bg-bg-darkest backdrop-blur supports-[backdrop-filter]:bg-bg-darkest/95">
      <div className="container flex h-16 max-w-screen-xl items-center px-4">
        <div className="flex w-full justify-between items-center">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <Link href="/trade">
              <span className={`text-sm font-medium hover:text-white ${location === '/trade' ? 'text-white' : 'text-text-secondary'}`}>
                Trade
              </span>
            </Link>
            <Link href="/leaderboard">
              <span className={`text-sm font-medium hover:text-white ${location === '/leaderboard' ? 'text-white' : 'text-text-secondary'}`}>
                Leaderboard
              </span>
            </Link>
            <Link href="/games">
              <span className={`text-sm font-medium hover:text-white ${location === '/games' ? 'text-white' : 'text-text-secondary'}`}>
                Games
              </span>
            </Link>
            <Link href="/watch">
              <span className={`text-sm font-medium hover:text-white ${location === '/watch' ? 'text-white' : 'text-text-secondary'}`}>
        </div>
      ...
      {/* Right Section - Wallet Connect or User Profile */}
      <div className="flex items-center space-x-4">
        {!connected ? (
          <Button className="bg-accent-primary hover:bg-accent-primary/90 text-white rounded-md py-2 px-4">
            Connect Wallet
          </Button>
        ) : (
          <>
